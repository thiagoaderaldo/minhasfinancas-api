...
public class UsuarioResourceTest {
	...
	public void deveRetornarBadRequestAoObterErroDeAutenticacao() throws Exception{
		...
		Mockito.when(uService.autenticar(email, senha)).thenThrow(ErroAutenticacao.class);
	...
	public void deveCriarUmNovoUsuario() throws Exception{
		...
		Mockito.when(uService.salvarUsuario(Mockito.any(Usuario.class))).thenReturn(usuario);
	...
	public void deveRetornarBadRequestAoTentarCriarUmUsuarioInvalido() throws Exception{
		...
		Mockito.when(uService.salvarUsuario(Mockito.any(Usuario.class))).thenThrow(RegraNegocioException.class);
