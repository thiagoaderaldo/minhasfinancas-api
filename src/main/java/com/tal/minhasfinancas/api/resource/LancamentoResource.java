...
import com.tal.minhasfinancas.api.dto.AtualizaStatusDTO;
...
//	public LancamentoResource(LancamentoService service, UsuarioService uService) {
//		
...
//			@RequestParam java.util.Map<String, String> params //caso esta linha fosse utilizada todos os parâmetros seriam opcionais.
			
			@RequestParam(value = "descricao", required = false) String descricao,
			@RequestParam(value = "mes", required = false) Integer mes,
			@RequestParam(value = "ano", required = false) Integer ano,
			@RequestParam("usuario") Long idUsuario //item obrigatório
		...
		Optional<Usuario> usuario = uService.obterPorId(idUsuario);
